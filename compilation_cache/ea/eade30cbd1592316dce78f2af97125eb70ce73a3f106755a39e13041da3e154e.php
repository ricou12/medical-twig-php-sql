...
class __TwigTemplate_c35d4614011eeedac311e5b7138a37256d4a3eb6f7be22560621cfd88d038544 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row d-flex justify-content-center\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["info"]) {
            ...
            echo "                <ul class=\"list-group my-2\">
                    <li class=\"list-group-item\">date du Rdv : ";
            // line 34
            ...
            echo "</li></a></li>
                    <li class=\"list-group-item\">heure du Rdv : ";
            // line 35
...
<div class=\"container\">
    <div class=\"row d-flex justify-content-center\">
        <div class=\"col-12 col-lg-6 mt-2 border p-2 rounded\">
            ...
            <ul class=\"list-group my-2\">
                <li class=\"list-group-item\">Nom : {{patient[0].lastname}}
                </li>
                </a>
                </li>
                <li class=\"list-group-item\">Prénom : {{patient[0].firstname}}
                </li>
                </a>
                </li>
                <li class=\"list-group-item\">Date de naissance : {{patient[0].birthdate}}
                </li>
                </a></li>
                <li class=\"list-group-item\">Télephone : {{patient[0].phone}}</li></a></li>
                <li class=\"list-group-item\">Email : {{patient[0].mail}}</li></a></li>
            </ul>
            <div class=\"p-3 bg-warning border text-dark w-50\">
                <h2>Mes rendez-vous</h2>
            </div>
            {% for info in patient %}
                <ul class=\"list-group my-2\">
                    <li class=\"list-group-item\">date du Rdv : {{info.dateRdv}}</li></a></li>
                    <li class=\"list-group-item\">heure du Rdv : {{info.heureRdv}}</li></a></li>
                </ul>
            {% endfor %}
        </div>
    </div>
</div>
{% endblock %}", "patients/profil-patient.html.twig", "C:\\wamp64\\www\\medical-twig-php-sql\\templates\\patients\\profil-patient.html.twig");
    }
}
